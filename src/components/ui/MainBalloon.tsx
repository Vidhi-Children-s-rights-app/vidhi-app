...
export const MainBalloon: React.FC<Props> = ({
  ...
  const [{ translateX, translateY, scale }, { stop, resume, pause }] = useSpring(
    () => ({
      from: INITIAL_STATE,
  ...
  return (
    ...
    >
      <Svg width="100%" height="100%" viewBox="0 0 183 219" fill="none">
        <Path
      ...
      <EmergencyMessage open={setPauseBalloon} />
    </animated.View>
  );
};
