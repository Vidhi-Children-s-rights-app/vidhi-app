...
import { ChoiceType, MascotDialogueType, ModuleState } from '../../types';
...
const GameView: React.FC<{
  ...
  return (
    ...
    >
      ...
      {mascotDialogue && <MascotDialogue content={mascotDialogue} />}
    </View>
  );
};
...
const MascotDialogue: React.FC<{ content: MascotDialogueType }> = ({
  content
}) => {
...
const Choice: React.FC<{ choice: string; index: number }> = ({
  ...
  return (
    ...
    >
      <Text style={{ height: '100%', width: '100%', fontFamily: 'regular', marginVertical: '3%', marginHorizontal: '5%', fontSize: 16 }}>
        {choice}
      </Text>
    </View>
  );
